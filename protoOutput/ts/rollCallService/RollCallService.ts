...
import type { RealTimePresences as _rollCallService_RealTimePresences, RealTimePresences__Output as _rollCallService_RealTimePresences__Output } from '../rollCallService/RealTimePresences';
...
export interface RollCallServiceClient extends grpc.Client {
  ...
  GetRealTimePresences(argument: _rollCallService_ReattachReq, metadata: grpc.Metadata, options?: grpc.CallOptions): grpc.ClientReadableStream<_rollCallService_RealTimePresences__Output>;
  GetRealTimePresences(argument: _rollCallService_ReattachReq, options?: grpc.CallOptions): grpc.ClientReadableStream<_rollCallService_RealTimePresences__Output>;
  getRealTimePresences(argument: _rollCallService_ReattachReq, metadata: grpc.Metadata, options?: grpc.CallOptions): grpc.ClientReadableStream<_rollCallService_RealTimePresences__Output>;
  getRealTimePresences(argument: _rollCallService_ReattachReq, options?: grpc.CallOptions): grpc.ClientReadableStream<_rollCallService_RealTimePresences__Output>;
  
  ListActiveRollCalls(argument: _rollCallService_ListRollCallsReq, metadata: grpc.Metadata, options: grpc.CallOptions, callback: (error?: grpc.ServiceError, result?: _rollCallService_ListRollCallsRes__Output) => void): grpc.ClientUnaryCall;
  ListActiveRollCalls(argument: _rollCallService_ListRollCallsReq, metadata: grpc.Metadata, callback: (error?: grpc.ServiceError, result?: _rollCallService_ListRollCallsRes__Output) => void): grpc.ClientUnaryCall;
  ListActiveRollCalls(argument: _rollCallService_ListRollCallsReq, options: grpc.CallOptions, callback: (error?: grpc.ServiceError, result?: _rollCallService_ListRollCallsRes__Output) => void): grpc.ClientUnaryCall;
  ListActiveRollCalls(argument: _rollCallService_ListRollCallsReq, callback: (error?: grpc.ServiceError, result?: _rollCallService_ListRollCallsRes__Output) => void): grpc.ClientUnaryCall;
  listActiveRollCalls(argument: _rollCallService_ListRollCallsReq, metadata: grpc.Metadata, options: grpc.CallOptions, callback: (error?: grpc.ServiceError, result?: _rollCallService_ListRollCallsRes__Output) => void): grpc.ClientUnaryCall;
  listActiveRollCalls(argument: _rollCallService_ListRollCallsReq, metadata: grpc.Metadata, callback: (error?: grpc.ServiceError, result?: _rollCallService_ListRollCallsRes__Output) => void): grpc.ClientUnaryCall;
  listActiveRollCalls(argument: _rollCallService_ListRollCallsReq, options: grpc.CallOptions, callback: (error?: grpc.ServiceError, result?: _rollCallService_ListRollCallsRes__Output) => void): grpc.ClientUnaryCall;
  listActiveRollCalls(argument: _rollCallService_ListRollCallsReq, callback: (error?: grpc.ServiceError, result?: _rollCallService_ListRollCallsRes__Output) => void): grpc.ClientUnaryCall;
...
export interface RollCallServiceHandlers extends grpc.UntypedServiceImplementation {
  ...
  GetRealTimePresences: grpc.handleServerStreamingCall<_rollCallService_ReattachReq__Output, _rollCallService_RealTimePresences>;
  
  ListActiveRollCalls: grpc.handleUnaryCall<_rollCallService_ListRollCallsReq__Output, _rollCallService_ListRollCallsRes>;
